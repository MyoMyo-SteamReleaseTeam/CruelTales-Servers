...
namespace CT.Common.Synchronizations
{
	...
	public class DEF_SyncNetworkObjectDefinitionAttribute : Attribute
	{
	...
	/// </summary>
	[AttributeUsage(AttributeTargets.Class)]
	public class DEF_SyncObjectDefinitionAttribute : Attribute
	{
		/// <summary>
		...
		public DEF_SyncObjectDefinitionAttribute(bool isCustom = false)
		{
			IsCustom = isCustom;
		}
	}
	...
	public class DEF_SyncObjectAttribute : Attribute
	{
		public SyncType SyncType { get; private set; }
		public SyncDirection SyncDirection { get; private set; }

		public DEF_SyncObjectAttribute(SyncType sync = SyncType.Reliable,
	...
	/// </summary>
	[AttributeUsage(AttributeTargets.Field)]
	public class DEF_SyncVarAttribute : Attribute
	{
		public SyncType SyncType { get; private set; }
		public SyncDirection SyncDirection { get; private set; }

		public DEF_SyncVarAttribute(SyncType sync = SyncType.Reliable,
								SyncDirection dir = SyncDirection.FromMaster)
		{
			SyncType = sync;
			SyncDirection = dir;
	...
	public class DEF_SyncRpcAttribute : Attribute
	{
		public SyncType SyncType { get; private set; }
		public SyncDirection SyncDirection { get; private set; }

		public DEF_SyncRpcAttribute(SyncType sync = SyncType.Reliable,
								SyncDirection dir = SyncDirection.FromMaster)
		{
			SyncType = sync;
			SyncDirection = dir;
