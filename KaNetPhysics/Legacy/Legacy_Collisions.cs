...
{
	public static class Legacy_Collisions
	{
		...
		public static bool IntersectAABBs(Legacy_AabbBoundary a, Legacy_AabbBoundary b)
		{
			return !(a.Max.X <= b.Min.X || b.Max.X <= a.Min.X ||
				a.Max.Y <= b.Min.Y || b.Max.Y <= a.Min.Y);
		}

		public static void FindContactPoints(Legacy_RigidBody bodyA, Legacy_RigidBody bodyB,
											 ...
											 out int contactCount)
		{
			...
			Legacy_ShapeType shapeTypeA = bodyA.ShapeType;
			Legacy_ShapeType shapeTypeB = bodyB.ShapeType;

			if (shapeTypeA is Legacy_ShapeType.Box)
			{
				if (shapeTypeB is Legacy_ShapeType.Box)
				{
				...
				else if (shapeTypeB is Legacy_ShapeType.Circle)
				{
			...
			else if (shapeTypeA is Legacy_ShapeType.Circle)
			{
				if (shapeTypeB is Legacy_ShapeType.Box)
				{
		...
		public static bool Collide(Legacy_RigidBody bodyA, Legacy_RigidBody bodyB,
