/*
 * Generated File : Master_ZTest_Value32NoTarget
 * 
...
namespace CTS.Instance.SyncObjects
{
	...
	public partial class ZTest_Value32NoTarget
	{
		...
		private List<int> f14Callstack = new(4);
		public partial void f17(int a)
		{
			f17Callstack.Add(a);
		...
		private List<int> f22Callstack = new(4);
		public partial void f24(int a)
		{
			f24Callstack.Add(a);
		...
		private List<int> uf3Callstack = new(4);
		public partial void uf14(int a)
		{
			uf14Callstack.Add(a);
			_dirtyUnreliable_3[3] = true;
		}
		private List<int> uf14Callstack = new(4);
		public partial void uf17(int a)
		{
			uf17Callstack.Add(a);
		...
		private List<int> uf22Callstack = new(4);
		public partial void uf24(int a)
		{
			uf24Callstack.Add(a);
		...
		private List<int> uf28Callstack = new(4);
